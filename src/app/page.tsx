    ...
    <>
      ...
      <section className="relative overflow-hidden pt-32 pb-16 sm:pt-40 sm:pb-24">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-14 lg:gap-10 items-start">
            <div>
              <p className="annotation mb-6" style={{ color: "var(--signal)" }}>
                [ FOUNDER-LED AI &amp; SOFTWARE STUDIO ]
              </p>
              <h1 className="display text-[clamp(34px,7vw,72px)] mb-7 max-w-[720px]">
                AI-integrated
                <br />
                software. Engineered
                <br />
                for <span style={{ color: "var(--signal)" }}>real-world use</span>.
              </h1>
              <p className="text-[17px] sm:text-[19px] mb-10 max-w-[520px]" style={{ color: "var(--muted)" }}>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-1 gap-x-6 gap-y-6 lg:gap-y-5">
                {FLAGSHIP_STATS.map((s) => (
                  <div key={s.label} className="lg:row lg:py-4 lg:first:border-t-0">
                    <div className="font-display font-semibold" style={{ fontSize: "clamp(26px,3vw,32px)", lineHeight: 1, color: "var(--signal)" }}>
      ...
      <section className="relative pt-4 pb-20 sm:pb-28">
        <div className="container">
          ...
          <h2 className="display text-[clamp(24px,4vw,38px)] max-w-[640px] mb-14">
        ...
        <div className="container">
          <Reveal className="mt-4 mb-8">
            <Link href="/projects" className="font-mono text-[13px] inline-flex items-center gap-1.5" style={{ color: "var(--signal)" }}>
              View all seven case studies <IconGlyph name="ArrowRight" size={12} weight="bold" aria-hidden="true" />
            </Link>
          </Reveal>
        </div>
      </section>
